...
function FlipCard({
  ...
  return (
    <div
      className="group relative w-full max-w-[450px] cursor-pointer"
...
export function GlobalNetworks({
  ...
  return (
    <section
      ...
      aria-label="Global Networks"
    >
      <Container>
        {showHeadingAbove && (
          <ScrollReveal direction="up" distance={40} duration={0.6}>
            <h2 className=" mb-2 qs-reg text-center text-[clamp(1.75rem,3.5vw,3.125rem)] uppercase leading-tight tracking-[0.05em] text-brand-text-primary">
              {heading}
            </h2>
          </ScrollReveal>
        )}
        ...
        {showKnowMore && (
          <ScrollReveal direction="up" distance={24} delay={0.3} duration={0.6}>
            <div className="mt-6 mb-4 flex justify-center sm:mb-0">
              <OutlineArrowButton
                href="/our-brand"
