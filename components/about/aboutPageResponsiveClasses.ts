...
export const aboutBrandPromiseIntroBox = cn(
	"mt-2 bg-white py-3 sm:py-4 lg:py-5",
);
...
/** Partner brands */
export const aboutBrandsSection = cn(
	"bg-[#F2F2F2] py-10 sm:py-14 lg:py-12 xl:py-16",
);
...
export const aboutBrandsCtaWrap = cn(
	"mt-10 flex justify-center sm:mt-12 lg:mt-12.5",
