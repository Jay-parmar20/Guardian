  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (resumeFile) {
      try {
        ...
        cvFileId = (uploadResult as { data?: { id?: number } })?.data?.id ?? null;
      } catch {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        <div className="mt-2 border-t border-[#8F8183]/30 pt-3 text-center">
          <p className="n-bold text-xs uppercase tracking-[0.08em] text-brand-text-primary">
            For HR Related Enquiries
          </p>
          <div className="mt-2 flex flex-wrap items-center justify-center gap-4 text-sm text-[#161616]">
