...
const bandValueClassName =
	"n-bold tabular-nums whitespace-nowrap text-left text-brand-footer font-extrabold leading-none tracking-normal text-[28px] sm:text-[36px] md:text-[44px] lg:text-[56px]";

function formatCountUpValue(
	count: number,
	config: DeveloperStatCountUp,
): string {
				...
				>
					<div
						className={cn(
							...
							isTwoColInline
								...
								: cn(
										"relative h-full w-full min-w-0 items-start text-left",
					...
					>
						{isTwoColInline ? (
							...
							<div className="flex w-full min-w-0 flex-col items-start gap-3 sm:gap-4 lg:gap-5">
								<StatFigure
									stat={stat}
									isInView={hasAnimatedStats ? isInView : false}
									animationIndex={idx}
								/>
								<p className="w-full max-w-full shrink-0 n-bold font-bold text-[16px] leading-[20px] text-left normal-case tracking-normal text-pretty text-black">
									{stat.label}
								</p>
							</div>
						)}
	...
	return (
		<div className="mx-auto w-full min-w-0  bg-[#F2F2F2]">
			<div className=" border-[#000000]  ">
				...
				>
					<div className="relative mx-auto w-full max-w-[min(100%,519px)] px-4 pt-4 pb-4 lg:max-w-none lg:px-0 lg:pl-[30px] lg:pt-[30px] lg:pb-[30px]">
						<div
						...
						>
							<AnimatePresence custom={direction} initial={false} mode="wait">
								<motion.div
									...
									custom={direction}
									variants={
										shouldReduceMotion ? undefined : leadershipImageVariants
									}
					...
					{/*  */}
					<div className="flex flex-col justify-between py-2 max-lg:items-center max-lg:text-center lg:py-8 md:mr-6 lg:items-stretch lg:text-left">
						<div className="w-full max-lg:flex max-lg:flex-col max-lg:items-center">
							<AnimatePresence custom={direction} initial={false} mode="wait">
								<motion.div
									...
									custom={direction}
									variants={
										shouldReduceMotion ? undefined : leadershipTopVariants
									}
									initial={shouldReduceMotion ? false : "enter"}
									animate="center"
									exit={shouldReduceMotion ? undefined : "exit"}
						...
						<div className="mt-8 w-full sm:mt-10">
							<AnimatePresence custom={direction} initial={false} mode="wait">
								<motion.div
									...
									custom={direction}
									variants={
										shouldReduceMotion ? undefined : leadershipBottomVariants
									}
									initial={shouldReduceMotion ? false : "enter"}
									animate="center"
									exit={shouldReduceMotion ? undefined : "exit"}
