...
const bandValueClassName =
  "n-bold tabular-nums text-center text-brand-footer leading-none tracking-[-0.03em] text-[clamp(1.35rem,5.5vw,2rem)] text-balance max-md:whitespace-normal md:whitespace-nowrap sm:text-4xl md:text-[clamp(2.25rem,4vw,2.85rem)] md:tracking-[-0.04em]";
            ...
            {isTwoColInline ? (
              ...
              <div className="flex w-full min-w-0 flex-col items-center gap-1 md:gap-1.5">
                <StatFigure
                  ...
                  animationIndex={idx}
                />
                <p className="w-full max-w-full shrink-0 n-bold font-bold text-[16px] lh-20 text-center normal-case tracking-normal leading-snug text-pretty text-black">
                  {stat.label}
                </p>
              </div>
            )}
