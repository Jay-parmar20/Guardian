            ...
            {[
              ...
              <div key={stat.label} className="flex items-center gap-6 sm:gap-10 md:gap-14 lg:gap-16">
                ...
                <div className="text-center">
                  <div className={cn("n-bold tabular-nums text-center text-brand-footer leading-none tracking-[-0.03em] text-[clamp(1.35rem,5.5vw,2rem)] sm:text-4xl md:text-[clamp(2.25rem,4vw,2.85rem)] md:tracking-[-0.04em]", stat.customClass)}>
                    {stat.value}
                  </div>
