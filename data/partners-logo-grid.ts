...
/** New Home page partner logos — Group 29.svg, Group 30.svg, etc. */
export function homePartnerLogoFromGroup(group: number): {
	src: string;
	alt: string;
} {
	return {
		src: `/images/Colour%20logos/home-partner-logo/Group%20${group}.svg`,
		alt: KNOWN_PARTNER_NAMES[group] ?? `Partner brand ${group}`,
	};
}
