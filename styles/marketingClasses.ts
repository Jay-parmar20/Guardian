...
export const marketingClasses = {
	sectionMuted: " bg-brand-background-muted ",
	section: " bg-brand-background ",
	sectionCompact: " bg-brand-background ",
	sectionPartners: " bg-brand-background-subtle ",
	sectionStats: " bg-brand-background-muted ",
	headingDisplay:
		"md:mt-7 qs-reg text-[clamp(1.75rem,3.5vw,3.125rem)] fs-5xl uppercase leading-tight ls-5 text-brand-text-primary text-[#202225]",
	headingDisplayMd:
